...
class ModalView extends HTMLElement {
    constructor(modelComponent) {
        ...
        this._selectEstadoOption = document.createElement("option");
        this._selectEstadoOption.innerText = "Estado";
        this._selectEstadoOption.value = "0";
        this._selectEstado.appendChild(this._selectEstadoOption);
    ...
    closeModal() {
        ...
        this._inputTrueque.value = "";
        this._selectEstado.selectedIndex = "0";
        this._selectCategoria.selectedIndex = "0";
        this.tagSelected = [];
        this.images = [];
        this._containerImages.childNodes.forEach((i) => this._containerImages.removeChild(i));
        this._categoriesTagContainer.childNodes.forEach((i) => this._categoriesTagContainer.removeChild(i));
    }
    ...
    connectedCallback() {
        ...
        this._form.onsubmit = (event) => {
            ...
            const state = this._selectEstado.value !== "0" ? this._selectEstado.value : "";
